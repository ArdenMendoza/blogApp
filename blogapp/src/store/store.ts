...
import { FetchBlogsEpic, AddBlogEpic, UpdateBlogEpic, DeleteBlogEpic} from './epic/blogEpic';
...
const configureEpic = () => {
    return combineEpics(FetchBlogsEpic, AddBlogEpic, UpdateBlogEpic, DeleteBlogEpic);
}
